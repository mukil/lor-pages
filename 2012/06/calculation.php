...
if (isset($_GET['lor'])) {
    ...
    // ### lor_row get_lor_row($agegroup_id);
    echo "Get value for an agegroup over all LORs.";#
    return;
}
...
function get_age_data($dataset, $lor) {
    ...
    $meta = '{ "lor_name": "'.$lor['lor_name'].'", "total_inhabitants": '.$inhabitants.', "district": "Berlin-'.$lor['district'].'", "as_of" : "Juni 2012" }';
...
// $age_data = json_encode($string_data);
// var_dump($age_data);
print $string_data;
